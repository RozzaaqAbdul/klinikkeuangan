          ...
          <div class="form-group">
              <strong>
			    ...
			    <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="sisa_waktu" name="sisa_waktu" value="<?php echo $sisa_waktu ?> tahun" readonly>
                    </div>
			    </div>

			    <div class="form-group">
			    	<strong>
			      	    <label for="validationDefaultUsername">Kebutuhan dana pendidikan (dengan nilai saat ini):</label>
			      	</strong>
                    <div class="input-group">
                ...
                <div class="form-group">
			    	<strong>
			      	    <label for="validationDefaultUsername">Kebutuhan dana pendidikan (saat akan dibutuhkan):</label>
			      	</strong>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
			    ...
			    <div class="form-group">
			    	<strong>
			            <label for="validationDefaultUsername">Tingkat imbal hasil kategori rendah (8% per tahun)</label>
			        </strong>
			        <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
                ...
                <div class="form-group">
			    	<strong>
			            <label for="validationDefaultUsername">Tingkat imbal hasil kategori sedang (12% per tahun)</label>
			        </strong>
			        <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
                ...
                <div class="form-group">
			    	<strong>
			            <label for="validationDefaultUsername">Tingkat imbal hasil kategori tinggi (16% per tahun)</label>
			        </strong>
			        <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
