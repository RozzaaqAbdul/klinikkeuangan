      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item" style="background-image: url('img/intro-carousel/2.jpg');">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Persiapan adalah kunci menuju sukses</h2>
                <p>Begitupula situasi keuangan dan berbagai harapan kita dalam hidup, belum tentu selamanya mulus dan sesuai harapan.  Sudah siapkah kita ? Sudahkah kita memiliki perencanaan yang memadai ?</p>
                <a href="#featured-services" class="btn-get-started scrollto">Get Started</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url('img/intro-carousel/3.jpg');">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Belajar dari Seekor Semut</h2>
                <p>“Apakah biaya pendidikan putra-putri kita sudah terencana dengan baik dan telah mencukupi kebutuhan biaya pendidikan yang terus meningkat di masa yang akan datang ?”</p>
                <a href="#featured-services" class="btn-get-started scrollto">Get Started</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url('img/intro-carousel/4.jpg');">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Menuju Indonesia Hebat</h2>
                <p>Perencanaan Keuangan seharusnya adalah sesuatu aktivitas yang menyenangkan, mudah dipahami dan terjangkau oleh semua orang. Perencana Keuangan yang baik akan membantu Anda untuk mengidentifikasi kondisi keuangan Anda dan keluarga, membuat proyeksi dan perencanaan keuangan yang sesuai bagi Anda dan keluarga, serta membantu Anda untuk mengevaluasi dan memonitor implementasinya.</p>
                <a href="#featured-services" class="btn-get-started scrollto">Get Started</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url('img/intro-carousel/5.jpg');">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Hemat Pangkal Kaya</h2>
                <p>Kami, akan bekerjasama dengan Anda untuk menjadikan Perencanaan Keuangan sesuatu yang menyenangkan, mudah dipahami dan terjangkau oleh kemampuan Anda. Hubungi kami untuk informasi lebih lanjut.</p>
                <a href="#featured-services" class="btn-get-started scrollto">Get Started</a>
              </div>
            </div>
          </div>
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              ...
              <h2 class="title"><a href="#">Rencana Masa Depan Dengan Nabung Saham</a></h2>
              <p>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              ...
              <h2 class="title"><a href="#">Rencana Masa Depan Dengan Reksadana</a></h2>
              <p>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              ...
              <h2 class="title"><a href="#">Rencana Masa Depan Dengan Unit Link</a></h2>
              <p>
