        ...
        <div class="row about-cols">
          ...
          <div class="col-md-5 wow fadeInUp container">
            <div class="about-col">
              ...
              <h2 class="title"><a href="#">Layanan Perencanaan Keuangan</a></h2>
          ...
          <div class="col-md-5 wow fadeInUp container" data-wow-delay="0.1s">
            <div class="about-col">
              ...
              <h2 class="title"><a href="#">Layanan Saran Keuangan</a></h2>
              <p>
          ...
          <div class="col-md-5 wow fadeInUp container" data-wow-delay="0.2s">
            <div class="about-col">
              ...
              <h2 class="title"><a href="#">Layanan Analisa Produk dan Jasa Keuangan</a></h2>
              <p>
          ...
          <div class="col-md-5 wow fadeInUp container">
            <div class="about-col">
              ...
              <h2 class="title"><a href="#">Layanan Financial Health Check & Financial State Analysis</a></h2>
              <p> 
