...
<body>
  ...
  <section id="testimonials" style="padding-bottom:20vw;">
    <div class="intro-container">
        <div class="col-sm-12" style="background: url('<?php echo base_url('assets/img/home/Header Background RED.svg');?>'); background-repeat: no-repeat; background-size: cover; height:100vh">
            <div class="row" style="padding-top:0px">
            	...
            	<form id="simulasi-jiwa-form" method="post" action="<?php echo base_url()?>dana_pensiun_result/send_to_mail" role="form">
            ...
            <strong>
                  <label for="validationDefaultUsername" hidden="">Email :</label>
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="email" name="email" value="<?php echo $email ?>" readonly hidden>
                    </div>
                </div>
          <div class="form-group">
			    	<strong>
			      	    <label for="validationDefaultUsername">Nilai uang pensiun per bulan yang diharapkan (sesuai nilai saat ini) :</label>
			      	</strong>
                    <div class="input-group">
                ...
                <div class="form-group">
			    	<strong>
			      	    <label for="validationDefaultUsername">Nilai uang pensiun per bulan yang diharapkan (saat memulai pensiun) :</label>
			      	</strong>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
			    ...
			    <div class="form-group">
			    	<strong>
			            <label for="validationDefaultUsername">Nilai uang pensiun tahunan yang dibutuhkan (saat memulai pensiun) :</label>
			        </strong>
			        <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
                ...
                <div class="form-group">
			    	<strong>
			            <label for="validationDefaultUsername">Nilai total dana pensiun yang dibutuhkan untuk pensiun sesuai rencana :</label>
			        </strong>
			        <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
                ...
                <div class="form-group">
			    	<strong>
			            <label for="validationDefaultUsername">Nilai investasi bulanan yang diperlukan untuk pensiun - imbal hasil tinggi :</label>
			        </strong>
			        <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
                ...
                <div class="form-group">
			    	<strong>
			            <label for="validationDefaultUsername">Nilai investasi bulanan yang diperlukan untuk pensiun - imbal hasil sedang :</label>
			        </strong>
			        <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
                ...
                <div class="form-group">
			    	<strong>
			            <label for="validationDefaultUsername">Nilai investasi bulanan yang diperlukan untuk pensiun - imbal hasil rendah :</label>
			        </strong>
			        <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupPrepend2">Rp.</span>
      ...
      <form id="generate_to_pdf" method="post" action="<?php echo base_url()?>dana_pensiun_result/generate_to_pdf" role="form">
