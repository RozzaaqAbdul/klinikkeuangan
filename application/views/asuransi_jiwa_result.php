    ...
    <div class="intro-container">
        <div class="col-sm-12" style="background: url('<?php echo base_url('assets/img/home/Header Background RED.svg');?>'); background-repeat: no-repeat; background-size: cover; height:100vh">
            <div class="row" style="padding-top:0px">
			    ...
			    <div class="form-group">
			      ...
			      <div class="input-group">
			        ...
			        <input type="text" class="form-control" id="value1" name="value1" value="<?php echo number_format($value1) ?>" placeholder="1000000" aria-describedby="inputGroupPrepend2" readonly>
			      </div>
			    </div>
			    ...
			    <div class="form-group">
			      ...
			      <div class="input-group">
			        ...
			        <input type="text" class="form-control" id="value2" name="value2" value="<?php echo number_format($value2) ?>" placeholder="8000000" aria-describedby="inputGroupPrepend2" readonly>
			      </div>
			    </div>
			    ...
			    <div class="form-group">
			      ...
			      <div class="input-group">
			        ...
			        <input type="text" class="form-control" id="value3" name="value3" value="<?php echo number_format($value3) ?>" placeholder="10000000" aria-describedby="inputGroupPrepend2" readonly>
			      </div>
			    </div>
            ...
            <label for="validationDefaultUsername">Maka kebutuhan nilai pertanggungan asuransi jiwa Anda </label>
			      ...
			      <div class="input-group">
			        <input type="text" class="form-control" id="total" name="total" value="<?php echo number_format($total) ?>" placeholder="Total" aria-describedby="inputGroupPrepend2" readonly >
			      </div>
			    </div>
